...
class AirPlane {
  constructor () {
    ...
    var matCockpitTail = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matCockpit = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matTopWing = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matBottomWing = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matWingSupport = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matTailPlane = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
    ...
    var matTailWing = new THREE.MeshPhongMaterial({color: Colors.airplane, shading: THREE.FlatShading})
